...
class KelolaDataInovasi extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('/kepala_opd/inovasi/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('kepala_opd/inovasi/create', $data); // Tampilkan view form
    }
    ...
    public function store()
    {
        ...
        $logData = [
            ...
            'aksi' => 'tambah data',
            'jenis_data' => 'Inovasi',
            'keterangan' => "kepala dengan ID {$user->id} menambahkan data Inovasi dengan ID {$newInovasiId}",
        ];
    ...
    public function show($id_inovasi)
    {
        $data['inovasi'] = $this->inovasiModel
            ...
            ->first();
        return view('kepala_opd/inovasi/show', $data);
    }
    ...
    public function tolak()
    {
        ...
        if ($id_inovasi && $pesan) {
            ...
            return redirect()->to('/kepala/inovasi/')->with('success', 'Proposal berhasil ditolak dengan pesan.');
        }
    ...
    public function setujui()
    {
        ...
        if ($id_inovasi) {
            ...
            // Kirim respon sukses
            return redirect()->to('/kepala/inovasi/')->with('success', 'Proposal berhasil disetujui.');
        }
    ...
    public function revisi()
    {
        ...
        return redirect()->to('/kepala/inovasi/filter')->with('success', 'Proposal berhasil diperbarui ke status revisi.');
    }
}
