...
public function storeOpd()
{
    ...
    if ($this->opdModel->save($data)) {
        ...
        return redirect()->to('/superadmin/opd/create')->with('success', 'Data OPD berhasil ditambahkan dan log tercatat.');
    } else {
    ...
    public function updateOpd($id){
        ...
        if ($opdModel->update($id, $data)) {
            ...
            return redirect()->to('/superadmin/list_opd')->with('success', 'Data berhasil diperbarui!');
        }else{
