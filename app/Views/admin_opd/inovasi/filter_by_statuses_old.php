...
<body>
    <div class="container">
        ...
        <!-- <a href="/admin/inovasi" class="btn btn-primary mb-3">Ke Daftar Proposal</a> -->
                    ...
                    <?php foreach ($inovasi as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- 
                                <a href="/admin/inovasi/edit/<?= $row['id_inovasi']; ?>" class="btn btn-warning btn-sm">Edit</a> -->
                                <!-- <a href="/admin/inovasi/delete/<?= $row['id_inovasi']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">Delete</a> -->
