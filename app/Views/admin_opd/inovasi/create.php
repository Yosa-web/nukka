        ...
        <div class="container-fluid">
                    ...
                    <div
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="<?= base_url('admin/inovasi/filter') ?>">Daftar Proposal</a>
                                </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/inovasi/store" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                ...
                                <div class=" row">
                                        <div class="col-12">
                                            <div class="d-flex justify-content-end">
                                                <button type="button" class="btn btn-secondary w-md" onclick="window.location.href='<?= base_url('admin/inovasi/filter') ?>'">Batal</button>
...
<script>
    $(document).ready(function() {
        $('#kecamatan').change(function() {
            ...
            if (id_kecamatan) {
                $.ajax({
                    url: '/admin/inovasi/getDesa', // Sesuaikan dengan endpoint yang akan dibuat
                    type: 'GET',
                    data: {
