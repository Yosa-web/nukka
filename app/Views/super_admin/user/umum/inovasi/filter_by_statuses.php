...
<body>
    <div class="container">
        ...
        <!-- <a href="/userumum/inovasi" class="btn btn-primary mb-3">Ke Daftar Proposal</a> -->

        <a href="/userumum/inovasi/create" class="btn btn-success mb-3">Tambah Proposal</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($row['status'] === 'revisi'): ?>
                                    <a href="/userumum/inovasi/edit/<?= $row['id_inovasi']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <?php endif; ?>
                                <!-- 
                                <a href="/userumum/inovasi/edit/<?= $row['id_inovasi']; ?>" class="btn btn-warning btn-sm">Edit</a> -->
                                <!-- <a href="/userumum/inovasi/delete/<?= $row['id_inovasi']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">Delete</a> -->
