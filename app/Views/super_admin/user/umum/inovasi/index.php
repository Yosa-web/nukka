...
<body>
    <div class="container">
        ...
        <a href="/userumum/inovasi/filter" class="btn btn-primary mb-3">Ke Daftar Proposal</a>
                        ...
                        <div class="modal fade" id="modalTolak" tabindex="-1" aria-labelledby="modalTolakLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="formTolak" method="post" action="/userumum/inovasi/tolak">
                                        <?= csrf_field() ?>
    ...
    <script>
        function ubahStatus(id, status) {
            $.ajax({
                url: '/userumum/inovasi/updateStatus/' + id,
                type: 'POST',
                data: {
                    status: status,
