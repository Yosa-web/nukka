                                        ...
                                        foreach ($inovasi as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <div class="me-2">
                                                            <a href="/sekertaris/inovasi/edit/<?= $row['id_inovasi']; ?>" class="btn btn-outline-warning btn-sm edit mb-2" title="Edit">
    ...
    function setujuiInovasi(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.post('/sekertaris/inovasi/setujui', {
                    id_inovasi: id,
...
<script>
    function ubahStatus(id, status) {
        $.ajax({
            url: '/sekertaris/inovasi/updateStatus/' + id,
            type: 'POST',
            data: {
                status: status,
                '<?= csrf_token() ?>': '<?= csrf_hash() ?>'
