...
<body>
    <div class="container">
        ...
        <a href="/kepala/inovasi" class="btn btn-primary mb-3">Ke Daftar Proposal</a>

        <a href="/kepala/inovasi/create" class="btn btn-success mb-3">Tambah Proposal</a>
                ...
                if (!empty($inovasi)): ?>
                    ...
                    <?php foreach ($inovasi as $row): ?>
                        <tr>
                            ...
                            <td>
                                <!-- <a href="/kepala/inovasi/edit/<?= $row['id_inovasi']; ?>" class="btn btn-warning btn-sm">Edit</a> -->
                                <!-- <a href="/kepala/inovasi/delete/<?= $row['id_inovasi']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">Delete</a> -->
