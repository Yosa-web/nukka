                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-end">
                            <button type="button" class="btn btn-primary waves-effect btn-label waves-light" onclick="window.location.href='/kepala/inovasi/create'"><i class="bx bx-plus label-icon"></i>Tambah Data</button>
                        </div>
                        <div class="card-body">
                                        ...
                                        <?php foreach ($inovasi as $row): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="/kepala/inovasi/delete/<?= $row['id_inovasi']; ?>" class="btn btn-outline-danger btn-sm delete ms-2 mb-3" title="Delete" onclick="return confirm('Yakin ingin menghapus data ini?')">
